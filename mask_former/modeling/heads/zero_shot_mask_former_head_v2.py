...
class ZeroShotMaskFormerHeadV2(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        return {
            ...
            "embed_decoder": EmbeddingDecoder(
                hidden_dim=cfg.MODEL.SEM_SEG_HEAD.MASK_DIM,
                num_layers=cfg.MODEL.SEM_SEG_HEAD.EMBED_HEAD.NUM_LAYERS,
    ...
    def layers(self, features):
        ...
        predictions["pix_embedding"]=self.embed_decoder(mask_features)
        return predictions
